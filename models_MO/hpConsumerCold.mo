...
model hpConsumerCold
    ...
    parameter Modelica.SIunits.Temperature Tin_hot=273+20 "K";
    ...
    Modelica.SIunits.Temperature Tin_cold = hp.ht.ht.staA1.T;
...
protected
    ...
    DHS.Subnetworks.hp_user hp(redeclare package Medium = Medium1, redeclare package MediumUser = Medium2,
            ht( redeclare DHS.HeatTransfer.Carnot_Tpi ht,
                hpMode = DHS.Types.HPmode.Cooling, 
            ...
            pump(pump(m_flow=mflow_in_cold))
        );
...
Modelica.Blocks.Sources.Constant T_target( k=Tout_cold_target );
